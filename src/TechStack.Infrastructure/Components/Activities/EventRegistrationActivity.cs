...
public class EventRegistrationActivity(ILogger<EventRegistrationActivity> logger, IEndpointAddressProvider provider) :
    IActivity<EventRegistrationArguments, EventRegistrationLog>
{
    readonly ILogger<EventRegistrationActivity> _logger = logger;
