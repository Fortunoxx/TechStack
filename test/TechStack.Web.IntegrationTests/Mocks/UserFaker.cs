...
public class UserFaker : AutoFaker<User>
{
    ...
    public UserFaker(string domain, int id = 1) : base(Constants.Locale)
    {
        ...
        RuleFor(x => x.DownVotes, faker => faker.Random.Int(min: 0, max: 1000));
        ...
        RuleFor(x => x.Reputation, faker => faker.Random.Int(min: 0, max: 1000));
        RuleFor(x => x.UpVotes, faker => faker.Random.Int(min: 0, max: 1000));
        RuleFor(x => x.Views, faker => faker.Random.Int(min: 0, max: 1000));
